                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/article/{{ $post->id }}/edit" class="btn btn-success" >Edit</a> 
                        ...
                        <div class="modal-body">
                            <form action="/article" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('content') is-invalid @enderror" placeholder="Leave a comment here" name="content" id="content"></textarea>
                                    @error('content')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
